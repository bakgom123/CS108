...
class CalculatorApp:
    ...
    def __init__(self, app):
        ...
        self.operator_choice = ButtonGroup(box, options=['+', '-', '*', '/'], grid=[0, 2, 2, 1],selected='+', horizontal=True)
        PushButton(box, text = 'Calculate', grid=[0,3], command = self.do_calculation)
        self.result_text = Text(box, grid = [1,3], align = 'right')
    ...
    def do_calculation(self):
        ...
        # Change the result text to match the value of result.
