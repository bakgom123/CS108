...
class LineAnimation:
    ...
    def draw_frame(self):
        ...
        # Draw the line
        self.drawing.line(self.x1, self.y1, self.x2, self.y2, color='#808080')

        # Move the right coordinate down one pixel.
        self.y2 += 1
        
        # Stop the animation when line's right end-point reaches the bottom right of the canvas.
        if self.y2 == self.height:
            app.repeat(0, self.draw_frame)
